...
**狀態：** 分支開發中（`codex/p8-incremental-scan`，不在 `main` 直接開發；P8a/P8b/P8c 已完成，P8d-1 已完成）  
...
**建議切分：** P8a baseline/state loader + 最小 scan state（已完成）、P8b incremental priority（已完成）、P8c changed-only/reuse（已完成）、P8d-1 sitemap 讀取與摘要（已完成）、P8d-2 priority signal、P8d-3 保守 seed、P8e 文件與呈現。
