...
- P9b-1 大型 report / NDJSON 輔助輸出已完成第一版；GUI log artifacts 會新增 `checked.ndjson`、`broken.ndjson`、`external-links.ndjson`，且 GUI SSE complete event 不再傳完整 report。下一步是 P9b-2 Analyzer 大檔保護。
