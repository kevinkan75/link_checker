...
- [P8_INCREMENTAL_SCAN_ANALYSIS.md](P8_INCREMENTAL_SCAN_ANALYSIS.md)：P8 incremental scan 的範圍邊界、舊 report/state 比對、新舊 URL 判斷、入口、GUI 呈現與分階段建議。
...
- P7 TTL URL result cache 已完成第一版與發布收尾，實作前評估記錄於 `P7_CACHE_EVALUATION.md`，發布驗收記錄於 `P7_RELEASE_CLOSURE.md`；P8 incremental scan 分析記錄於 `P8_INCREMENTAL_SCAN_ANALYSIS.md`。
