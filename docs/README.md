...
- [P7_CACHE_EVALUATION.md](P7_CACHE_EVALUATION.md)：P7 TTL URL result cache 的實作前評估、MVP 範圍、風險與驗收建議；P7 已完成第一版。
- [P7_RELEASE_CLOSURE.md](P7_RELEASE_CLOSURE.md)：P7 發布收尾紀錄、驗收結果、使用者可見變更與 P8 交接邊界。
- [P8_INCREMENTAL_SCAN_ANALYSIS.md](P8_INCREMENTAL_SCAN_ANALYSIS.md)：P8 incremental scan 的範圍邊界、舊 report/state 比對、新舊 URL 判斷、sitemap、reused result、GUI / Analyzer 呈現與分階段紀錄。
...
- P7 TTL URL result cache 已完成第一版與發布收尾，實作前評估記錄於 `P7_CACHE_EVALUATION.md`，發布驗收記錄於 `P7_RELEASE_CLOSURE.md`；P8 incremental scan 第一版已完成主要功能與呈現收尾，分析與驗收紀錄於 `P8_INCREMENTAL_SCAN_ANALYSIS.md`。
